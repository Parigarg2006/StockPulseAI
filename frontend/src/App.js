            ...
            {leaderboard.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Middle: Progress Bar */}
                  <div className="hidden md:flex items-center justify-center w-[200px] flex-shrink-0 mx-6">
                    <div className="h-2 w-full bg-zinc-800 rounded-full overflow-hidden flex relative">
                      ...
                      <div className="w-1/2 flex justify-end">
                        {isNegative && (
                          <div 
                            ...
                            className="h-full bg-gradient-to-l from-[#f43f5e] to-[#ef4444] rounded-l-full shadow-[0_0_10px_#f43f5e]"
                          ></div>
                        )}
                      </div>
                      ...
                      <div className="w-1/2">
                        {isPositive && (
                          <div 
                            style={{ width: `${barWidth}%` }} 
                            className="h-full bg-gradient-to-r from-[#10b981] to-[#059669] rounded-r-full shadow-[0_0_10px_#10b981]"
                          ></div>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <span className={`text-[14.5px] font-extrabold font-mono w-16 text-right ${
                      isPositive ? 'text-[#10b981] drop-shadow-[0_0_4px_#10b981]' :
